...
//					TileMaster tile = (TileMaster) ctx.getServerHandler().playerEntity.world.getTileEntity(((ContainerFRequest) ctx.getServerHandler().playerEntity.openContainer).tile.getMaster());
//					if (tile == null)
//						return;
