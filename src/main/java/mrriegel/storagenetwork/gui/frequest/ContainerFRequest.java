...
//			if (itemstack.getCount() != 1 || !(FluidContainerRegistry.isContainer(itemstack) || itemstack.getItem() instanceof IFluidContainerItem))
//				return null;
//			if (slotIndex < 2) {
...
//			return false;
//		if (!playerIn.world.isRemote && playerIn.world.getTotalWorldTime() % 20 == 0) {
//			ItemStack drain = tile.drain;
//			TileMaster mas = (TileMaster) playerIn.world.getTileEntity(tile.getMaster());
